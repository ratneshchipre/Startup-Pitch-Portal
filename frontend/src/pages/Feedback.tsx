      ...
      <div className="w-full mini-desktop:w-auto px-[1.5rem] py-[1rem] mt-[4.6rem] mini-desktop:ml-[20rem]">
        <div className="flex justify-between gap-[2rem] items-center w-full">
          ...
          <div className="bg-blue-200 text-center py-[0.5rem] px-[1rem] rounded-lg">
            <span className="font-Medium text-[1.3rem] text-txt-black">
              Average: 4{" "}
              <FontAwesomeIcon
                icon={faStar}
                className="text-blue-500 ml-[0.3rem]"
              />
            </span>
          </div>
        </div>
          ...
          <div className="flex flex-col items-start bg-cream-white tablet-2:w-full px-[2rem] py-[1.5rem] rounded-lg shadow-md">
            <div className="flex flex-col gap-[1.2rem]">
              <div className="flex gap-[1.3rem]">
                ...
                <div>
                  <h3 className="font-Medium text-[1.1rem] text-txt-black">
                    Ratnesh Chipre
                  </h3>
                  <span className="font-Regular text-[1.1rem] text-txt-gray-black">
                    4{" "}
                    <FontAwesomeIcon
                      icon={faStar}
                      className="text-blue-500 ml-[0.2rem]"
                    />
                  </span>
                </div>
              </div>
              <div className="flex flex-col">
                <span className="font-Regular text-txt-gray-black text-[1.1rem]">
                  Strong vision but needs more financial projections.
                </span>
              </div>
            </div>
          </div>
