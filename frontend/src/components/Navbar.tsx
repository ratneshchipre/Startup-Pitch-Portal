...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-center items-center">
      <div
        className={`fixed flex justify-between items-center w-full top-0 py-[0.8rem] ${
          isOpen ? "border-b-dash-border border-b-[1.5px]" : ""
        } px-[1.5rem] lg:px-[4rem] xl:px-[7rem] z-100 backdrop-blur-sm bg-nav-white/70`}
      >
        ...
        <div className="flex gap-[0.8rem] items-center">
          <Link
            to="/account/login"
            className="hidden items-center font-Regular text-[1rem] sm:flex"
          >
            <button className="cursor-pointer">
              <h3 className="text-txt-gray-black hover:text-txt-black">
                LogIn
              </h3>
            </button>
          </Link>
        ...
        <div className="fixed top-0 z-90 backdrop-blur-sm bg-nav-white/70 border-b-dash-border border-b-[1.5px] flex flex-col w-full h-[13rem] items-end justify-end pb-[1.6rem] pr-[1.5rem]">
          <div className="flex flex-col justify-end gap-[1rem] items-end">
            <Link
              ...
              className="flex items-center font-Medium text-[1rem]"
            >
              <button className="cursor-pointer">
                <h3 className="text-txt-gray-black hover:text-txt-black text-[1.1rem]">
                  LogIn
                </h3>
              </button>
            </Link>
