    ...
    <div className='flex flex-col justify-center items-center px-[2rem]'>
      <div className='w-auto sm:w-[30rem] mx-auto bg-signin flex flex-col justify-center items-center py-[1.5rem] px-[2.5rem] mb-[2rem] mt-[7rem] shadow-lg rounded-2xl border-border border-[1px]'>
        ...
        <div className='flex w-full flex-col items-center'>
          ...
          <button onClick={handleGoogleLogin} className='flex w-full justify-center items-center mt-[1.5rem] font-Regular text-txt-gray-black border-border border-[1px] px-[0.4rem] py-[0.5rem] rounded-xl cursor-pointer hover:border-txt-black'>
          ...
          <form onSubmit={handleLogIn} className='w-full flex flex-col justify-center items-center'>
            ...
            <button
              className={`font-Regular mt-[1rem] bg-border text-nav-white w-full py-[0.5rem] text-center rounded-lg cursor-not-allowed transition ${!logInEnabled ? 'cursor-not-allowed' : 'cursor-pointer bg-btn-blue'}`}
              disabled={loading}
            >
              Continue
